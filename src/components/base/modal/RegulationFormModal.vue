...
async function onSubmit(event: Event) {
  try {
    ...
    formData.append('date', moment(regulationData.date).format('YYYY-MM-DD'))
    ...
    props.regulationId
      ? await updateById(props.regulationId, formData)
            ...
            <div v-if="activeValue === 'uz'" class="columns is-multiline pt-5">
              <div class="column is-12">
                <VField :label="$t('Title_uz')" required>
                  <VControl>
                    <VTextarea
                      :placeholder="t('Type_title_uz')"
                      v-model="regulationData.title.uz"
                      :rows="3"
            ...
            <div v-else-if="activeValue === 'ru'" class="columns is-multiline pt-5">
              <div class="column is-12">
                <VField :label="$t('Title_ru')">
                  <VControl>
                    <VTextarea
                      :placeholder="t('Type_title_ru')"
                      v-model="regulationData.title.ru"
                      :rows="3"
                    />
                  </VControl>
                </VField>
            ...
            <div v-else-if="activeValue === 'en'" class="columns is-multiline pt-5">
              <div class="column is-12">
                <VField :label="$t('Title_en')">
                  <VControl>
                    <VTextarea
                      :placeholder="t('Type_title_en')"
                      v-model="regulationData.title.en"
                      :rows="3"
                    />
                  </VControl>
                </VField>
