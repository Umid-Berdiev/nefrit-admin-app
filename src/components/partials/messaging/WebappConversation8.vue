  ...
  <div id="navbar-conversation-8" class="chat-area-content">
    <div class="chat-area-header">
      ...
      <div class="chat-area-group">
        <img class="chat-area-profile" src="/images/avatars/svg/vuero-3.svg" alt="" data-user-popover="4"
    ...
    <div class="chat-area-main">
      <div class="chat-msg">
        <div class="chat-msg-profile">
          <img class="chat-msg-img" src="/images/avatars/svg/vuero-3.svg" alt="" data-user-popover="7"
            @error.once="(event) => onceImageErrored(event, '150x150')" />
