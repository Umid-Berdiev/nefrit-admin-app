...
const imageUrl = ref('')
const currentLocation = ref([41.2543754, 69.1679692])
await fetchData()
...
async function fetchData() {
  ...
  if (res.point_y && res.point_y) {
    currentLocation.value = [res.point_x, res.point_y]
  }
}
