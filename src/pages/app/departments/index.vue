...
import DepartmentFormModal from '/@src/components/base/modal/DepartmentFormModal.vue'
...
<template>
  <div class="applicant-list-wrapper">
        ...
        <VFlexTable rounded>
          ...
          <template #body-cell="{ row, column, value, index }">
            ...
            <template v-if="column.key === 'actions'">
              <DepartmentFlexTableDropdown @edit="onEdit(row)" @remove="onRemove" />
            </template>
          </template>
        </VFlexTable>
    ...
    <DepartmentFormModal v-model="isFormModalOpen" :item="selectedRole" />
  </div>
</template>
